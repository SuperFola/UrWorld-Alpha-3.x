...
class Mana:
    def __init__(self, ecran, carte, blocs):
        self.mana = 100
        self.ecran = ecran
        self.img_mana = pygame.image.load(".." + os.sep + "assets" + os.sep + ".." + os.sep + "assets" + os.sep + "GUI" + os.sep + "Bar" + os.sep + "imgo.png").convert_alpha()
        self.carte = carte
        self.blocs = blocs
        self.v_droite = 1
        self.v_gauche = -1
        ...
        self.dico_img = {
            'laser': [pygame.image.load(".." + os.sep + "assets" + os.sep + "Particules" + os.sep + "laser.png").convert_alpha(), 12],
            'feu': 4,
            'build': 12,
            'sphere': [pygame.image.load(".." + os.sep + "assets" + os.sep + "Particules" + os.sep + "boule.png").convert_alpha(), 8],
            'conic': [pygame.image.load(".." + os.sep + "assets" + os.sep + "Particules" + os.sep + "conic.png").convert_alpha(), 6]
        }
