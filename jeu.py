...
def jeu(fenetre, choix, dossier_personnage, peacefull, fps, volume_son_j, creatif,
    ...
    with open("Parties" + os.sep + "dossier.sav", "wb") as dossier_ecrire:
        pickler_9 = pickle.Pickler(dossier_ecrire)
        pickler_9.dump(dossier_personnage)
    ...
    #spetre du laser
    #septre de la téléportation
    #spetre du feu
    #septre du cone
    #septre de la sphere
    #septre de la construction
    ...
    last_pos = (0, 0)
    breakListe = []
    icone_jeu = "ico.ico" if sys.platform.startswith("win32") else "ico.xbm"
    son_bool = True
    mort = False
    windowed_is = False
    show_stats = True
    ...
    def drag_and_drop_invent(fenetre, font, blocs, img_tous_blocs, s, root, nb_blocs_large,
        ...
        while continue3:
            ...
            #pygame.draw.rect(fenetre, couleur_idd, (10, 10, 580, 334))
            fenetre.blit(inventaire, (10, 10))

            #carte
            #pygame.draw.rect(fenetre, couleur_idd, (center_x, center_screen, 560, 240))
    ...
    def flash(fenetre, carte):
        pygame.draw.rect(fenetre, (240, 240, 240),
                         (0, 0, taille_fenetre_largeur_win, y_herbe))
        pygame.display.flip()
    ...
    if os.path.exists("Parties" + os.sep + "equipement_en_cours.sav") \
        ...
        with open('Parties' + os.sep + 'equipement_en_cours.sav', 'rb') as lire_equipement:
            ...
            number_of_case = {v: k for k, v in enumerate([elt for line in _S_ for elt in line])}[obj_courant]
    ...
    if not os.path.exists('Parties' + os.sep + 'pos.sav'):
        ...
        with open("Parties" + os.sep + "classe.sav", "w") as determine_classe:
            determine_classe.write(str(classe_personnage))
    ...
    while continuer:
        ...
        for evennements_fenetre in [pygame.event.poll()]:
            ...
            #controles autour de la souris
                ...
                if evennements_fenetre.button == 5:  #la molette descend
                    obj_courant, number_of_case = molette_(_S_, number_of_case, 'bas')
                elif evennements_fenetre.button == 4:  #la molette monte
                    obj_courant, number_of_case = molette_(_S_, number_of_case, 'haut')
            ...
            #controles au clavier
                ...
                #controle de l'affichage de l'inventaire Drag&Drop
                    ...
                    obj_courant, _S_ = drag_and_drop_invent(fenetre, font, blocs, [carte.get_img_dict(), niveau_pkg.img_], _S_,
        ...
        if show_cursor:
            ...
            aff_bloc(root, obj_courant, carte.get_img_dict(), rcenter, _S_, blocs.dict_name(), font, blocs)
        else:
